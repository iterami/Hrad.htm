...
function repo_init(){
    core_repo_init({
      ...
      'storage-menu': '<table><tr><td><input id=day-event-duration min=1 type=number><td>Event Duration'
        + '<tr><td><input id=day-events min=1 type=number><td>Events/Day</table>',
      'title': 'Hrad.htm',
    });
